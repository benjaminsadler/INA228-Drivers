...
These drivers deliver their output to stout, and do not report measurement units nor append a newline at the end (but you may easily add these).  The implied units are:
