...
These four drivers provide quick measurements of four different values (bus voltage, current, power, and die temp) with simple bash scripts.  They are easy to integrate into a linux project without any compatibility layers or special python environments.
